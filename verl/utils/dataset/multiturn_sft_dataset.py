...
#         # Process conversation incrementally to track positions accurately
#         full_input_ids = []
#         loss_mask = []
        
#         for i, msg in enumerate(messages):
#             # Get conversation up to and including this message
...
#                 new_tokens = partial_tokens[prev_len:]
...
#             else:
#                 loss_mask.extend([0] * len(new_tokens))
...
#         }
#         try:
#             with open("losses_and_inputs.txt", "a") as f:  # Changed "w" to "a" for append mode
#                 json.dump(to_save, f)
#                 f.write("\n")
